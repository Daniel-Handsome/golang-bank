...
func (x *UserReponse) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x2b, 0x0a, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c,
	...
	0x6c, 0x2f, 0x6d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x2d, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2f,
...
var file_rpc_create_user_proto_goTypes = []interface{}{
	...
	(*UserReponse)(nil),       // 1: pb.userReponse
	(*User)(nil),              // 2: pb.User
}
var file_rpc_create_user_proto_depIdxs = []int32{
	2, // 0: pb.userReponse.user:type_name -> pb.User
