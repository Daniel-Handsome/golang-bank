...
type SimpleBankClient interface {
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserReponse, error)
...
func (c *simpleBankClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserReponse, error) {
	out := new(UserReponse)
...
type SimpleBankServer interface {
	CreateUser(context.Context, *CreateUserRequest) (*UserReponse, error)
...
func (UnimplementedSimpleBankServer) CreateUser(context.Context, *CreateUserRequest) (*UserReponse, error) {
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "servuce.simple_bank.proto",
}
